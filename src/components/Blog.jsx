  ...
  return (
    <div className="container mx-auto px-4">
       ...
       <div className=" w-full lg:w-1/4 p-2 shadow-2xl space-y-2 rounded-lg cursor-pointer hover:scale-105 transition duration-300 ease-in-out">
            <img className='h-64 md:h-96 lg:h-40 w-full rounded-lg' src="assets/blog-1.avif" alt="img" />
           ...
           <div className=" w-full lg:w-1/4 p-2 shadow-2xl space-y-2 rounded-lg cursor-pointer hover:scale-105 transition duration-300 ease-in-out">
            <img className='h-64 md:h-96 lg:h-40 w-full rounded-lg' src="assets/blog-2.avif" alt="img" />
        ...
        {/* card 3 */}
        <div className=" w-full lg:w-1/4 p-2 shadow-2xl space-y-2 rounded-lg cursor-pointer hover:scale-105 transition duration-300 ease-in-out">
            <img className='h-64 md:h-96 lg:h-40 w-full rounded-lg' src="assets/blog-3.avif" alt="img" />
        ...
        <div className=" w-full lg:w-1/4 p-2 shadow-2xl space-y-2 rounded-lg cursor-pointer hover:scale-105 transition duration-300 ease-in-out">
            <img className='h-64 md:h-96 lg:h-40 w-full rounded-lg' src="assets/blog-4.avif" alt="img" />
         ...
         <div className=" w-full lg:w-1/4 p-2 shadow-2xl space-y-2 rounded-lg cursor-pointer hover:scale-105 transition duration-300 ease-in-out">
            <img className='h-64 md:h-96 lg:h-40 w-full rounded-lg' src="assets/blog-5.avif" alt="img" />
         ...
         <div className=" w-full lg:w-1/4 p-2 shadow-2xl space-y-2 rounded-lg cursor-pointer hover:scale-105 transition duration-300 ease-in-out">
            <img className='h-64 md:h-96 lg:h-40 w-full rounded-lg' src="assets/blog-6.avif" alt="img" />
